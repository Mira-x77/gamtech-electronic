...
<div class="gs-center">
  ...
  <div class="gs-mob-top" id="gs-mob-top">
    <button class="gs-mob-menu-btn" id="gs-sb-tog" aria-label="<?php esc_attr_e( 'Menu', 'woodmart' ); ?>">
      <svg width="20" height="20" fill="none" stroke="#d4d4d8" stroke-width="2" viewBox="0 0 24 24"><line x1="3" y1="6" x2="21" y2="6"/><line x1="3" y1="12" x2="21" y2="12"/><line x1="3" y1="18" x2="21" y2="18"/></svg>
    </button>
    <a href="<?php echo esc_url( home_url( '/' ) ); ?>" class="gs-mob-top-logo"><img src="<?php echo esc_url( get_stylesheet_directory_uri() . '/assets/images/gamtech-logo.png' ); ?>" alt="GamTech" style="height:28px;width:auto"></a>
    <div style="display:flex;align-items:center;gap:6px;flex:1;min-width:0">
      <form method="get" action="<?php echo esc_url( home_url( '/' ) ); ?>" class="gs-mob-search-form">
        ...
        <button type="submit" aria-label="Search">
          <svg width="15" height="15" fill="none" stroke="#ffffff" stroke-width="2.5" viewBox="0 0 24 24"><circle cx="11" cy="11" r="8"/><line x1="21" y1="21" x2="16.65" y2="16.65"/></svg>
        </button>
      </form>
      <div style="position:relative;flex-shrink:0">
        <button class="gs-mob-cart-btn gs-ct-tog-btn" aria-label="<?php esc_attr_e( 'Cart', 'woodmart' ); ?>">
          <svg width="18" height="18" fill="none" stroke="#ffffff" stroke-width="2" viewBox="0 0 24 24"><circle cx="9" cy="21" r="1"/><circle cx="20" cy="21" r="1"/><path d="M1 1h4l2.68 13.39a2 2 0 0 0 2 1.61h9.72a2 2 0 0 0 2-1.61L23 6H6"/></svg>
        </button>
