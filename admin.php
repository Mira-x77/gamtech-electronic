 ...
 * Cookie-based auth: visit /admin?key=gamtech2026admin once to login
 */
session_start();
...
if ( ! empty( $_SESSION['gs_admin'] ) || ! empty( $_COOKIE['gs_admin'] ) ) {
    $_SESSION['gs_admin'] = true;
